// sidepanel.js
const QuickLinksImportCore = globalThis.QuickLinksImportCore;
if (!QuickLinksImportCore) throw new Error('QuickLinksImportCore is required before sidepanel.js');
const {
